...
namespace NovaGM.Services
{
    ...
    public static class MissionService
    {
        ...
        public static string SaveCurrentSessionAsMission(
            ...
            IEnumerable<ViewModels.Message> messages,
            string missionName,
            string description = "",
            ...
            string difficulty = "medium")
        {
            ...
            var mission = new Mission
            {
                ...
                InitialState = new MissionState
                {
                    ...
                    SuggestedLevel = 1, // Could be enhanced to detect from game state
        ...
        private static MissionNarrative ExtractNarrative(List<ViewModels.Message> messages)
        {
        ...
        private static List<string> ExtractObjectivesFromMessages(List<ViewModels.Message> playerMessages)
        {
        ...
        private static List<string> GenerateHooks(List<ViewModels.Message> gmMessages)
        {
        ...
        private static List<Encounter> ExtractEncounters(List<ViewModels.Message> messages)
        {
