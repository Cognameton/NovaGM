...
namespace NovaGM.Services
{
    ...
    public static class CharacterGenerator
    {
        ...
        /// <summary>
        /// Generate multiple character options for selection
        /// </summary>
        public static GeneratedCharacter[] GenerateOptions(int count = 3)
        {
            var options = new GeneratedCharacter[count];
            for (int i = 0; i < count; i++)
            {
                options[i] = GenerateRandom();
            }
            return options;
        }
